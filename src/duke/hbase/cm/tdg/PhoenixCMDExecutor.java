...
public class PhoenixCMDExecutor {
	...
	public void dropTablesInHbase(String dropSql){
		System.out.println("----------------------------------------------------------------------");
	     System.out.println("Deleting tables in Hbase");
		 String[] cmd = new String[]{psql, "localhost",dropSql};
		 ProcessExecutor pe = new ProcessExecutor("psql", cmd,PHOENIX_BIN_HOME);
         pe.read();
         pe.stop();		
	}
